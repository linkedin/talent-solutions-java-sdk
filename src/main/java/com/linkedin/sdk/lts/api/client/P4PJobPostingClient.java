...
public interface P4PJobPostingClient extends JobPostingClient {
   ...
   */
  P4PProvisionCustomerHiringContractsResponse provisionCustomerHiringContracts(
   ...
   * @throws LinkedInApiException if the API returns an error response
   */
  P4PReportResponseByIds getP4PReportByIds(@NonNull P4PJobReportsRequestByIds p4PJobReportsRequestByIds)
      throws AuthenticationException, LinkedInApiException, IllegalArgumentException;
   ...
   * @throws LinkedInApiException if the API returns an error response
   */
  P4PReportResponseByDate getP4PReportsByDate(@NonNull P4PJobReportsRequestByDate p4PJobPostingRequestByDate)
      throws AuthenticationException, LinkedInApiException, IllegalArgumentException;
   ...
   * @throws LinkedInApiException if the API returns an error response
   */
  P4PBudgetReportResponse getPartnerBudgetReports(@NonNull Long partnerContractId)
      throws AuthenticationException, LinkedInApiException, IllegalArgumentException;
}
