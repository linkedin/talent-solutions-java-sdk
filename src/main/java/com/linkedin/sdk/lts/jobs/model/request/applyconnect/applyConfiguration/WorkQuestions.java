...
/**
 * Represents the work experience questions configuration for a job application.
 * Controls work experience question sets and additional custom questions.
 *
...
@AllArgsConstructor
@NoArgsConstructor
public class WorkQuestions {

  /**
   * Work Experience set of repeatable questions.
   * Required field.
   */
  private WorkExperienceQuestionSet workExperienceQuestionSet;

  /**
   * Custom questions to be included within Work question section.
   */
