...
/**
 * Represents the education questions configuration for a job application.
 * Controls education experience question sets and additional custom questions.
 *
...
public class EducationQuestions {
  ...
  /**
   * Education Experience set of repeatable questions.
   * Required field.
   */
  private EducationExperienceQuestionSet educationExperienceQuestionSet;

  /**
   * Custom questions to be included within Education question section.
   */
